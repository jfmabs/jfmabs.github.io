...
Utilizando dados provenientes do Anuário Brasileiro de Segurança Pública e dos estudos sobre ideologia política dos partidos brasileiros de Zucco (2023) e Bolognesi (2022), comparo as médias de indicadores criminais em diferentes mandatos, com as ideologias políticas.
...
## Gráfico com estimativas intervalares de alguma variável de interesse
Distribuição da taxa de encarcerados/100.000hab por estado
...
- Estados governados por políticos de direita apresentam maiores taxas de encarceramento.

rmarkdown::render("/Users/jfmabs/jfmabs/tarefa4.Rmd")
cd /Users/jfmabs/jfmabs.github.io
